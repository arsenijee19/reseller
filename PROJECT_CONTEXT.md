...
- Completed functionality:
  ...
  - Reseller UI shows a one-time responsive release notes popup after successful login/session restore for the latest panel changes.
...
- Added a one-time responsive “Novo u reseller panelu” popup stored in browser localStorage and shown after successful login/session restore.
